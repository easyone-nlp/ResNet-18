...
def run_attack(dataset_name: str, attack_type: str, epsilons, target_class: int, num_samples: int, batch_size: int):
    ...
    image_path = results_dir / f"{dataset_name}_{attack_type}_fgsm.png"
    json_path = results_dir / f"{dataset_name}_{attack_type}_fgsm.json"
...
def main():
    parser = argparse.ArgumentParser(description="Run FGSM on the trained ResNet-18 models.")
